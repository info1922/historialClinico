...
<html class="no-js" lang="es" ng-app="moduloDatos">
  <head>
    ...
    <script type="text/javascript" src="../js/modulos/AspGine_CRUD.js"></script>
    <link rel="" href="DBpages/dbAspGine.php">

  </head>

  <body style="background-color:#F6F6F6" ng-controller="AspGine_CRUD">
