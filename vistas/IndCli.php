...
<html ng-app="moduloDatos" lang="es" >
  <head>
    <meta charset="utf-8">
    ...
    <script type="text/javascript" src="../js/modulos/IndCli_CRUD.js"></script>
    <link rel="" href="DBpages/dbIndCli.php">
    


  </head>

  <body style="background-color:#F6F6F6" ng-controller="IndCli_CRUD">
     <div class="grid-block main-body" >
        ...
        <div class="left-sidebar" style="width:50px" >
            ...
            <ul class="property-nav">
                ...
                <li class="patterntap current" ui-sref-active="current">
