...
<html class="no-js" lang="es" ng-app="moduloDatos" >
  <head>
    ...
    <script type="text/javascript" src="../js/modulos/Acti_CRUD.js"></script>
    <link rel="" href="DBpages/dbActi.php">
  ...
  <body style="background-color:#F6F6F6" ng-controller="Acti_CRUD">
...
<div class="grid-block main-body">
        ...
        <div class="left-sidebar" style="width:50px" >
            ...
            <ul class="property-nav">
                ...
                <li class="quips current" ui-sref-active="current">
