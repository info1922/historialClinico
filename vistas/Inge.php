...
<html ng-app="moduloDatos" lang="es" >
  <head>
    ...
    <script type="text/javascript" src="../js/modulos/Inge_CRUD.js"></script>
    <link rel="" href="DBpages/dbInge.php">


  </head>

  <body style="background-color:#F6F6F6" ng-controller="Inge_CRUD">
