...
<html class="no-js" lang="es" ng-app="moduloDatos">
  <head>
    ...
    <script type="text/javascript" src="../../js/modulos/Almacen_CRUD.js"></script>
    <link  href="../DBpages/dbAlmacen.php">
  ...
  <body style="background-color:#F6F6F6" ng-controller="Almacen_CRUD">
    <div class="grid-block main-body" >
        ...
        <div class="left-sidebar" style="width:50px" >
                ...
                <ul class="property-nav">
                    ...
                    <li class="word current" ui-sref-active="current">
